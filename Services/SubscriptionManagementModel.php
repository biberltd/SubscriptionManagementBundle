...
class SubscriptionManagementModel extends CoreModel{
     ...
     * @return \BiberLtd\Bundle\CoreBundle\Responses\ModelResponse
     */
    public function insertSubscriptions($collection)
    {
        $timeStamp = time();
     ...
     * @return \BiberLtd\Bundle\CoreBundle\Responses\ModelResponse
     */
    public function updateSubscriptions($collection)
    {
        $timeStamp = time();
        $countUpdates = 0;
        $updatedItems = array();
     ...
     * @return \BiberLtd\Bundle\CoreBundle\Responses\ModelResponse
     */
    public function deleteSubscriptions($collection)
    {
        $timeStamp = time();
        if (!is_array($collection)) {
            return $this->createException('InvalidParameterValueException', 'Invalid parameter value. Parameter must be an array collection', 'E:S:001');
    ...
    public function getSubscription($subscription){
        ...
        if ($subscription instanceof BundleEntity\Subscription) {
            return new ModelResponse($subscription, 1, 0, null, false, 'S:D:002', 'Entries successfully fetched from database.', $timeStamp, time());
        }
        $result = null;
        switch ($subscription) {
     ...
     * @return \BiberLtd\Bundle\CoreBundle\Responses\ModelResponse
     */
    public function insertSubscriptionPackages($collection){
        $timeStamp = time();
        if (!is_array($collection)) {
            return $this->createException('InvalidParameterValueException', 'Invalid parameter value. Parameter must be an array collection', 'E:S:001');
        }
     ...
     * @return \BiberLtd\Bundle\CoreBundle\Responses\ModelResponse
     */
    public function updateSubscriptionPackages($collection){
        $timeStamp = time();
        $countUpdates = 0;
        $updatedItems = array();
        $now = new \DateTime('now', new \DateTimeZone($this->kernel->getContainer()->getParameter('app_timezone')));
     ...
     * @return \BiberLtd\Bundle\CoreBundle\Responses\ModelResponse
     */
    public function deleteSubscriptionPackages($collection)
    {
        $timeStamp = time();
        if (!is_array($collection)) {
            return $this->createException('InvalidParameterValueException', 'Invalid parameter value. Parameter must be an array collection', 'E:S:001');
    ...
    public function getSubscriptionPackage($subscriptionPackage){
        ...
        if ($subscriptionPackage instanceof BundleEntity\SubscriptionPackage) {
            return new ModelResponse($subscriptionPackage, 1, 0, null, false, 'S:D:002', 'Entries successfully fetched from database.', $timeStamp, time());
        }
        $result = null;
     ...
     * @return \BiberLtd\Bundle\CoreBundle\Responses\ModelResponse
     */
    public function listSubscriptions($filter = null , $sortOrder = null, $limit = null){
        $timeStamp = time();
     ...
     * @return \BiberLtd\Bundle\CoreBundle\Responses\ModelResponse
     */
    public function listSubscriptionsOfMember($member, $sortOrder = null, $limit = null){
     ...
     * @return \BiberLtd\Bundle\CoreBundle\Responses\ModelResponse
     */
    public function listActiveSubscriptions($filter = null, $sortOrder = null, $limit= null){
        $filter[] = array(
            'glue' => 'and',
     ...
     * @return \BiberLtd\Bundle\CoreBundle\Responses\ModelResponse
     */
    public function listInActiveSubscription($filter = null, $sortOrder = null, $limit= null){
        $filter[] = array(
            'glue' => 'and',
     ...
     * @return \BiberLtd\Bundle\CoreBundle\Responses\ModelResponse
     */
    public function listCanceledSubscription($filter = null, $sortOrder = null, $limit= null){
        $filter[] = array(
            'glue' => 'and',
     ...
     * @return \BiberLtd\Bundle\CoreBundle\Responses\ModelResponse
     */
    public function listSubscriptionsOfSubscriptionPackage($subscriptionPackage, $sortOrder = null, $limit = null){
     ...
     * @return \BiberLtd\Bundle\CoreBundle\Responses\ModelResponse
     */
    public function listSubscriptionPackages($filter = null , $sortOrder = null, $limit = null){
        $timeStamp = time();
        if (!is_array($sortOrder) && !is_null($sortOrder)) {
            return $this->createException('InvalidSortOrderException', '$sortOrder must be an array with key => value pairs where value can only be "asc" or "desc".', 'E:S:002');
        }
     ...
     */
    public function listSubscriptionPackageOfType($type, $filter = null, $sortOrder = null, $limit= null){
        $timeStamp = time();
